...
public class DeadlineTest {
    ...
    public void constructor_validInput1_success() {
        try {
            Deadline deadline = new Deadline("valid input 1", "30-08-2023 23:59", new ArrayList<>());
    ...
    public void constructor_validInput2_success() {
        try {
            Deadline deadline = new Deadline("valid input 2", "30 Aug 2023 09:00 PM", new ArrayList<>());
    ...
    public void constructor_invalidInput_fail() {
        try {
            Deadline deadline = new Deadline("", "30/08/2023 2359", new ArrayList<>());
            fail();
        } catch (RooException exception) {
    ...
    public void getDate_validDate1_success() {
        try {
            Deadline deadline = new Deadline("valid date 1", "30-08-2023 21:00", new ArrayList<>());
    ...
    public void getDate_validDate2_success() {
        try {
            Deadline deadline = new Deadline("valid date 2", "30 Aug 2023 09:00 PM", new ArrayList<>());
            assertEquals(LocalDateTime.parse("30-08-2023 21:00", DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm")),
                    deadline.getDate());
        } catch (RooException exception) {
            fail();
