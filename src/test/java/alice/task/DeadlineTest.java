...
public class DeadlineTest {
    ...
    public void testStringConversion() {
        ...
        try {
            Deadline deadline = new Deadline("study", "2023-11-16T08:45:00", true, "school", "urgent");
            assertEquals("[D][X] study [school, urgent] (by: 8:45 AM, Nov 16 2023)", deadline.toString());
        } catch (Exception e) {
            // the test should not reach this line
        }
    }
    ...
    public void testFileStringConversion() {
        try {
            Deadline deadline = new Deadline("return book", "2023-08-06T14:00:00", false, "chore");
            assertEquals("D | 0 | return book | [chore] | 2023-08-06T14:00", deadline.toFileString());
        } catch (Exception e) {
            // the test should not reach this line
        }
        ...
        try {
            Deadline deadline = new Deadline("study", "2023-11-16T08:45:00", true, "school", "urgent");
            assertEquals("D | 1 | study | [school, urgent] | 2023-11-16T08:45", deadline.toFileString());
        } catch (Exception e) {
            // the test should not reach this line
        }
    }
