...
public class ParserTest {
    ...
    public void parseTodoTest2() {
        ...
        String output = "[T][ ][0] tododescription 123";
        try {
            Task task = Parser.parseLoading(input);
            assertEquals(output, task.toString());
        } catch (InvalidNumberException | InvalidRangeException | MissingTimeException | InvalidDateTimeException
    ...
    public void parseDeadlineTest1() {
        ...
        String output = "[D][ ][0] newdeadline1 (by: Dec 06 2020 18:00)";
        try {
            Task task = Parser.parseLoading(input);
            assertEquals(output, task.toString());
        } catch (InvalidNumberException | InvalidRangeException | MissingTimeException | InvalidDateTimeException
    ...
    public void parseDeadlineTest2() {
        ...
        String output = "[D][ ][0] newdeadline1 with spaced out text (by: Feb 16 2120 11:00)";
        try {
            Task task = Parser.parseLoading(input);
            assertEquals(output, task.toString());
        } catch (InvalidNumberException | InvalidRangeException | MissingTimeException | InvalidDateTimeException
    ...
    public void parseEventTest1() {
        ...
        String output = "[E][ ][0] newevent1 (from: Dec 06 2020 18:00 to: Dec 06 3020 18:00)";
        try {
            Task task = Parser.parseLoading(input);
            assertEquals(output, task.toString());
        } catch (InvalidNumberException | InvalidRangeException | MissingTimeException | InvalidDateTimeException
    ...
    public void parseEventTest2() {
        ...
        String output = "[E][ ][0] newevent2 with space text (from: Nov 06 1900 18:00 to: Dec 06 2020 23:00)";
        try {
            Task task = Parser.parseLoading(input);
            assertEquals(output, task.toString());
        } catch (InvalidNumberException | InvalidRangeException | MissingTimeException | InvalidDateTimeException
