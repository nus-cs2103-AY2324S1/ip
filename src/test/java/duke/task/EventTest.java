...
public class EventTest {
    ...
    void testGetStartTime() {
        Event event = new Event("test event getting start time", LocalDate.parse("2023-08-30"), LocalDate.parse("2023-08-31"));
    ...
    @Test
    void testToString() {
        Event event =  new Event("test event", LocalDate.parse("2023-08-30"), LocalDate.parse("2023-08-31"));
