...
public class MarkCommandTest {
    ...
    public void execute_taskNumberWithinIndex_success() {
        try{
            ...
            fail("IOException occurred when saving to storage");
        }
    }
    @Test
    public void execute_taskNumberOutOfIndex_exceptionThrown() {
        ...
        markCommand.execute(taskList, new Ui(), new Storage("data/testDuke.txt"));
        assertEquals("duke.exception.ChatException: ☹ OOPS!!! Please specify the correct task number.", outputStreamCaptor.toString().trim());
    }
}
