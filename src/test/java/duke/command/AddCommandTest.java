...
public class AddCommandTest {
    ...
    public void AddSingleTodo() throws DukeException {
        ...
        new AddCommand("todo read book", 'T').execute(testList, new Ui(), new Storage("data/tasks.txt"));
    ...
    public void AddManyTasks() throws DukeException {
        ...
        new AddCommand("event project meeting /from 2019-09-02 18:00 /to 2019-09-02 19:00", 'E').execute(testList, ui, storage);
    ...
    public void InvalidDate() {
        ...
        assertThrows(DateTimeParseException.class,
                () -> new AddCommand("event project meeting /from 2019-09-02 18:00 /to 2019-09 19:00", 'E').execute(testList, ui, storage));
    }
