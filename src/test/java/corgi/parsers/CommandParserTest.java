...
public class CommandParserTest {
    ...
    public void parse_invalidDeadlineCommand_throwsInvalidCommandFormatException() {
        ...
        assertThrows(InvalidCommandFormatException.class, () ->
                parser.parse("deadline Invalid deadline /by tomorrow"));
        //Todo: Bug found: should count number of /by before start splitting.
        // assertThrows(InvalidCommandFormatException.class,
        //         () -> parser.parse("deadline Invalid deadline /by 2023-09-22 /by 2023-09-23"));
        assertThrows(InvalidCommandFormatException.class, () ->
    ...
    public void parse_invalidEventCommand_throwsInvalidCommandFormatException() {
        ...
        assertThrows(InvalidCommandFormatException.class, () ->
                parser.parse("event"));
        assertThrows(InvalidCommandFormatException.class, () ->
                parser.parse("event Invalid event /from 2023-09-20"));
        assertThrows(InvalidCommandFormatException.class, () ->
                parser.parse("event Invalid event /to 2023-09-20"));
        assertThrows(InvalidCommandFormatException.class, () ->
                parser.parse("event Invalid event /to 2023-09-20 /to 2023-09-22"));
    }
}
