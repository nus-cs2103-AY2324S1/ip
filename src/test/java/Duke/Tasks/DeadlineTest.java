...
public class DeadlineTest {
    ...
    public void testStringConversion() {
        assertEquals(this.deadline.toString(), "[D][ ] return book (by: Aug 30 2023 22:19)");
    }

    @Test
    public void testStorageFileConversion() {
        assertEquals(this.deadline.formatForStorage(), "D | 0 | return book | 2023-08-30T22:19");
    }

    @Test
    public void testMarkDone() {
        this.deadline.markDone();
        assertEquals(this.deadline.toString(), "[D][X] return book (by: Aug 30 2023 22:19)");
    }
