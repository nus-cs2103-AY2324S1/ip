...
public abstract class Task implements Serializable {
    ...
    private static Optional<InvalidParameterState> invalidStateIfTaskParametersMissingOrBlank(
        ...
        if (optionalNamedParameterMap.isPresent()) {
            return Optional.of(new InvalidParameterState(
                    ErrorIndicatorIo.InvalidParameterState.PARAMETER_MISSING,
        ...
        if (optionalNamedParameterMap.isPresent()) {
            return Optional.of(new InvalidParameterState(
                    ErrorIndicatorIo.InvalidParameterState.PARAMETER_EMPTY,
                    optionalNamedParameterMap.get())
            );
        }
