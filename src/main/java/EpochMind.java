 ...
 */
public class EpochMind extends Application {
    ...
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/DaEpochMind.jpeg"));
