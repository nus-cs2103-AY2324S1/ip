...
public enum ErrorMessages {
    ...
    INVALID_TASK_NUMBER("I'm sorry, the task number you have entered a number " +
            "that exceeds the size of your task list."),
    ...
    MISSING_DEADLINE("Deadline is not provided. Please indicate your deadline by placing a " +
