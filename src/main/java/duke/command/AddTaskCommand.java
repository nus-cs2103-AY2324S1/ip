...
/**
 * Represents an add task instruction. Task type is generic, can be Todo,
 * Deadline etc
 */
public class AddTaskCommand extends Command {
	 ...
	 * @param arguments Represents the different possible arguments like /by /from
	 *                  etc
	...
	/**
	 * The actions to take during execute of command. Creates a task and adds it to
	 * tasklist.
	 */
	@Override
