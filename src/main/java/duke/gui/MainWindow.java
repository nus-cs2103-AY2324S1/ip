...
public class MainWindow extends AnchorPane {
    ...
    private Image userImage = new Image(this.getClass().getResourceAsStream("/images/DaFrog.jpg"));
    private Image dukeImage = new Image(this.getClass().getResourceAsStream("/images/DaBrain.jpg"));
