...
public class MainWindow extends AnchorPane {
    ...
    /**
     * Sets the Duke instance for the MainWindow and initializes the chat with Duke's welcome message.
     *
     * @param d The Duke instance to be associated with this MainWindow.
     */
