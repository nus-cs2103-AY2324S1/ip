...
/**
 * The `InvalidTaskCreationException` class is a custom exception that is thrown when an error occurs during the creation of a task in the Duke application.
