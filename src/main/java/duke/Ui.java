...
public class Ui {
    ...
    /**
     * Displays a prompt message a new to-do task is added to the tasklist.
     *
    ...
    /**
     * Displays prompt message when a new Deadlines task is added to the tasklist.
     *
    ...
    /**
     * Displays prompt message when a new Events task is added to the tasklist.
     *
    ...
    /**
     * Displays a prompt message when a task is deleted.
     *
    ...
    /**
     * Displays a prompt message when a task is marked as done.
     *
    ...
    /**
     * Displays a prompt message when a task is marked as not done.
     *
    ...
    /**
     * Displays a prompt message when the user enters an empty command.
     */
    public void empty() {
        System.out.println("   __________________________________________________________________________________");
    ...
    /**
     * Displays a prompt message when the user enters invalid command.
     */
    public void misc() {
        System.out.println("   __________________________________________________________________________________");
