...
public class DukeDialogBox extends HBox {
    ...
    private DukeDialogBox(String text, Image img) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(MainWindow.class.getResource("/view/DukeReplyDialogBox.fxml"));
     ...
     */
    public static DukeDialogBox greetingDialogBox(Image iv) {
        String greeting = "Welcome! I am Tom!";
        var duke = new DukeDialogBox(greeting, iv);
        duke.flip();
        return duke;
    }
}
