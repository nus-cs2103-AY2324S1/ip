...
public class Storage {
    ...
    /**
     * Creates a new file to store the tasks if it does not exist.
    ...
    /**
     * Gets the list of task stored in the storage.
    ...
    /**
     * Edits the storage according the new TaskList edited by the user.
