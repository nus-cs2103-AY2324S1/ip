...
//    private Image chatBot = new Image(this.getClass().getResourceAsStream("/images/Duke.png"));
...
//                DialogBox.getDukeDialog(dukeText, new ImageView(chatBot))
//        );
...
//
//    private void intro() {
//        Label dukeText = new Label(duke.intro());
//        dialogContainer.getChildren().addAll(
//                DialogBox.getDukeDialog(dukeText, new ImageView(chatBot))
//        );
//    }
