...
public class Parser {
     ...
     */
    public static String parseCommand(String command, String filePath, TaskList taskList) throws DukeException {
        String[] separateCommand = command.split(" ");
        System.out.println("--------------------------");
        if (command.equals("list")) {
//            System.out.println("Task List:");
//            taskList.printTaskList();
            return "Task List:" + taskList.printTaskListString();
...
//                    System.out.println(" Marked as done: ");
                    ...
                    return "   " + taskList.getTaskItem(taskNumber - 1).toString() + " Marked as done: ";
                } else if (command.startsWith("unmark")) {
                    taskList.getTaskItem(taskNumber - 1).markAsUndone();
//                    System.out.println(" Marked as not done yet: ");
                    writeLine(filePath, taskList);
                    return "   " + taskList.getTaskItem(taskNumber - 1).toString() + " Marked as not done yet: ";
                }
                writeLine(filePath, taskList);
...
//                        System.out.println(count + ". " + task);
                ...
                try {
                    ...
                    String result = "";
                    result += " I've added this task:" + "\n" + "   " + taskList.getTaskItem(
                            taskList.getSize() - 1).toString() + "\n" + " Now you have "
...
//                        System.out.println("   " + taskList.getTaskItem(taskNumber - 1).toString());
                        result += " Noted. I've removed this duke.task:" + "   " + taskList.getTaskItem(
                                taskNumber - 1).toString();
