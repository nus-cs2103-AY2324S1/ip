...
public class Duke extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/npc.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/bossmanAvatar.jpeg"));


    /**
     * Default constructor(Kind of for debug)
     */
    public Duke() {
        ui = new Ui();
        storage = new Storage("");
    ...
    public void start(Stage stage) {
        ...
        //Scroll down to end every time dialogContainer's height changes.
    ...
    private void handleUserInput() {
        ...
        Label dukeText = new Label(getResponse(userText.getText()));
