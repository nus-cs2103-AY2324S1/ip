...
public class Duke extends Application {
    ...
    private void handleUserInput() {
        ...
        String userLabelText = userText.getText();
        String dukeLabelText = dukeText.getText();

        dialogContainer.getChildren().addAll(
                DialogBox.getUserDialog(userLabelText, user),
                DialogBox.getDukeDialog(dukeLabelText, duke)
                );
        userInput.clear();
    }
