...
public class Duke extends Application{
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/Ken.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/Barbie.png"));
