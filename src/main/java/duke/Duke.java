 ...
 * Runs the program, focusing on the GUI.
 */
...
public class Duke extends Application {
    ...
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/Reaper.png"));
    private Runner runner = new Runner("./data/duke.txt");
    ...
    public String getResponse(String input) {
        return runner.runCommand(input);
    }
}
