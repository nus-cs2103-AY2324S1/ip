...
public class Parser {
    ...
    public String parseAndExecute(String input)
        ...
        // currentKey should be in keyword
        if (currentKey == Keyword.LIST) {
            return tasklist.getTaskList();
        }

        // key is a valid keyword but not LIST
        ...
        // should be of correct format: keyword + arguments
        String args = words[1];
        switch (currentKey) {
        case FIND:
        ...
        default:
            throw new RuntimeException("Should not reach this line in Parser!");
        }
    }
