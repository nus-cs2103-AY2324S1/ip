...
public class Duke extends Application{
    ...
    private Image nila = new Image(this.getClass().getResourceAsStream("/images/nila.jpg"));
    ...
    public void start(Stage stage) {
        ...
        Label welcomeUser = new Label(welcomeMessage);
        dialogContainer.getChildren().add(DialogBox.getDukeDialog(welcomeUser, new ImageView(nila)));
    ...
    private void handleUserInput() {
        ...
        dialogContainer.getChildren().addAll(
                ...
                DialogBox.getDukeDialog(dukeText, new ImageView(nila))
        );
        userInput.clear();
    }
    ...
    private String getResponse(String input) {
        return "Nila: \n" + Parser.parseCommand(input, taskManager, userInterface);
    }
