...
public class Parser {
    ...
    public static String readInput(String userInput, TaskList taskList) {
        // i really could shorten this method to less than 30LoC, but itll cause more abstraction layers.
        // abstracting each case out into their own respective method.
