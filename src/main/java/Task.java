...
//The Task class implements Serializable, and hence the tasklist generated by users
//can be written into a text file Duke.txt when exiting the chatBot.
//The tasklist can be opened again through reading the Duke.txt file the next time the chatBot is opened
