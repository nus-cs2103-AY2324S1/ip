...
public class TaskList {
    ...
    public String add(Task task) {
        list.add(task);
        updateFile();
        return "I Gotchu. This BanterBot.task added successfully:\n" + task.toString()
    ...
    public String mark(int idx) throws DukeException {
        ...
        return "Noice! I've marked this BanterBot.task as donezo:\n" + task;
    }
    ...
    public String unmark(int idx) throws DukeException {
        ...
        return "OK, I've marked this BanterBot.task as not done yet bruh:\n" + task;
    }
