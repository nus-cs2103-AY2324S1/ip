...
public class TaskList {
     ...
     * @throws IndexOutOfBoundsException when the index is not within the range of the list.
     */
    public String editTask(int index, String newDetails) throws IndexOutOfBoundsException {
