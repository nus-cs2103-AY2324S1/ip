 ...
 */
public class Sidtacphi extends Application {
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/SidUser.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/Sid.png"));
