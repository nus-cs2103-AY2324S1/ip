...
public class DialogBox extends HBox {
    ...
    private static final String SOCRATES_RESOURCE = "/view/SocratesDialogBox.fxml";
    @FXML
    ...
    public static DialogBox getSocratesDialog(String text) {
        return new DialogBox(text, SOCRATES_RESOURCE);
    }
}
