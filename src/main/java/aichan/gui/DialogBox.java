...
public class DialogBox extends HBox {
     ...
     *
     * @param text The response of AiChan.
     * @param img The image of AiChan.
     * @return The DialogBox with AiChan's image at the left.
     */
    public static DialogBox getAiChanDialog(String text, Image img) {
