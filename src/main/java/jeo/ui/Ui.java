...
/**
 * Functions as the user interface for the Je-O chatbot.
 *
...
public class Ui {
    ...
    /**
     * Returns an error message from the JeoException.
     *
     * @param e JeoException which error message is to be printed.
     * @return A String to be shown to the user.
     */
    public String errorMessage(JeoException e) {
        return e.toString();
    }
}
