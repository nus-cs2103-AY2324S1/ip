...
public class Parser {
    ...
    /**
     * Parses the input command and creates a chatterchicken.command.Command object.
     * This method extracts the action and task description from the input and returns a chatterchicken.command.Command object.
     *
     * @param input The input command provided by the user.
     * @return A chatterchicken.command.Command object representing the parsed command.
     ...
     * This method extracts task details from the input, creates a chatterchicken.command.Command object, and parses the Task type.
     *
