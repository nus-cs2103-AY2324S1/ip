 ...
 */
public class ChatterBot extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/DaQuokkaUser.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/DaQuokkaChatterBot.png"));
 ...
 */
 ...
 /** Iteration 2:
    ...
    private void handleUserInput() {
        ...
        Label chatterBotText = new Label(getResponse(userInput.getText()));
        dialogContainer.getChildren().addAll(
                new DialogBox(userText, new ImageView(user)),
                new DialogBox(chatterBotText, new ImageView(duke))
        );
        userInput.clear();
    }
