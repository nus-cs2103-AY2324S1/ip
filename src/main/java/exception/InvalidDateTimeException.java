...
/**
 * Represents an exception that is thrown when the application encounters an invalid date and time input.
 * <p>
 * This exception is triggered when the user provides a date and time format that does not match the expected formats:
