...
/**
 * The controller for the help pop up.
 */
public class HelpPopupController extends AnchorPane {
    ...
    /**
     * Initializes the HelpPopUp FXML.
     */
    @FXML
    ...
    /**
     * Set the top label of the Help PopUp.
     * @param text The text to set as the label of the Help Pop Up.
     */
