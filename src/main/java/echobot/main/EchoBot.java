...
/**
 * The echobot.main.EchoBot class represents the main application class, a chatbot program.
 */
public class EchoBot extends Application {
    ...
    private Scene scene;
    private Image user = new Image(getClass().getResourceAsStream("/user.png"));
    private Image echobot = new Image(getClass().getResourceAsStream("/echobot.png"));
    ...
    /**
     * The main entry point for the echobot.main.EchoBot application.
     *
    ...
    private void initializeUI(Stage stage) {
        ui = new Ui();
        storage = new Storage("data/echobot.txt", "data/notes.txt");
    ...
    private void configureStage(Stage stage) {
        stage.setTitle("echobot.main.EchoBot");
    ...
    /**
     * Displays both the user's message and echobot.main.EchoBot's response in the chat interface.
     *
     * @param userMessage    The user's message.
     * @param echoBotResponse The response generated by echobot.main.EchoBot.
     */
    ...
    /**
     * Displays echobot.main.EchoBot's welcome message and logo in the chat interface.
     *
     * @param echoBotResponse The welcome message generated by echobot.main.EchoBot.
     */
