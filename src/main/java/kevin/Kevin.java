...
public class Kevin extends Application {
    ...
    private Image kevin = new Image(this.getClass().getResourceAsStream("/images/kevin.png"));
    ...
    private void handleUserInput() {
        ...
        dialogContainer.getChildren().addAll(
                ...
                DialogBox.getDukeDialog(dukeText, new ImageView(kevin))
        );
        userInput.clear();
    }
