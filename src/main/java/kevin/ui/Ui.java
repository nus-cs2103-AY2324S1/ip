...
/**
 * Represents the user interface for the Kevin application.
...
public class Ui {
    ...
    public void showCommandNotRecognized() {
        System.out.println("Something went wrong with your command.");
    }

    public String showCommandNotRecognizedGui() {
        return "Something went wrong with your command";
    }

    public void showNoCommandDetail() {
        System.out.println("Something went wrong with your command detail.");
    }

    public String showNoCommandDetailGui() {
        return "Something went wrong with your command detail.";
    }
    ...
    public String showTimeParsingErrorGui() {
        return "OOPS!!! Please enter the date and time in the format: yyyy-mm-dd";
    }
    ...
    public String showDeleteGui(TaskList tasks, int index) throws CommandDetailException {
        return "Noted. I've removed the task. Now you have " + tasks.size()
                + " tasks in the list.";
    }
