...
public class Messages {
    ...
    public static final String MESSAGE_FILE_NOT_FOUND = "Unable to locate the file at /data/tasks.txt. Creating a new one now.";
    ...
    public static final String MESSAGE_DEADLINE_DESCRIPTION_ERROR = ":( OOPS!!! The description of a deadline cannot be empty.";
