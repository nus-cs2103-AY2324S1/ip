...
public class Parser {
    ...
    public static Task parseDeadline (String str) {
        String[] strSplit = str.split("\\s+");
    ...
    public static Task parseEvent(String str) {
        String[] strSplit = str.split("\\s+");
        ...
        for (int i = 1; i < strSplit.length; i++) {
            ...
            switch (field) {
                ...
                case "start" :
                    start.append(" ");
                    start.append((strSplit[i]));
                    break;
                case "end" :
                    end.append(" ");
                    end.append(strSplit[i]);
                    break;
            }
        }
